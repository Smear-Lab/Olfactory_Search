'''
FMOS Trainer 1 - Freely Moving Olfactory Search - ALTERNATION
    ...
    if state == 2:
        if port_val == leftport:
            if msg == 2:
                ...
                fmos_datamgt.write_trialsummary(trialsummary_file,trial_num,concentration_setting, leftport,response,tstart,tend)
                port_val = rightport
        ...
        if port_val == rightport:
            if msg == 1:
                ...
                print(str(trial_num - 1) + ". Left: " + str(leftcount)+ ". Right: " + str(rightcount) + ". IP: " + str(nosepokecount))
                fmos_datamgt.write_trialsummary(trialsummary_file,trial_num,concentration_setting, rightport,response,tstart,tend)
                port_val = leftport
